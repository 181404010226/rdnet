...
from rdnet import rdnet_tiny,rdnet_small
import os
import numpy as np
import random
import csv
...
if __name__ == "__main__":
    ...
    model = rdnet_small(num_classes=10).to(device)  # Assuming 10 classes for CIFAR-10
    ...
    with torch.no_grad():
        ...
        print(f"Orginal Test Accuracy: {accuracy:.4f}")
