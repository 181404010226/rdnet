...
def main():
    ...
    class CustomCIFAR10(torchvision.datasets.CIFAR10):
        def __init__(self, *args, **kwargs):
            ...
            self.industrial = [0, 1, 8, 9]  # airplane, automobile, ship, truck
            self.natural = [2, 3, 4, 5, 6, 7]  # bird, cat, deer, dog, frog, horse

        def __getitem__(self, index):
            img, target = super().__getitem__(index)
            # Assign 0 to industrial and 1 to natural
            if target in self.industrial:
                target = 0
            elif target in self.natural:
                target = 1
            return img, target
